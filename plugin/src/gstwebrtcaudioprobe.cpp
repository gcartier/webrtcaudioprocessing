...
static void
gst_webrtc_echo_probe_set_property (GObject * object,
...
static void
gst_webrtc_echo_probe_get_property (GObject * object,
...
gst_webrtc_echo_probe_class_init (GstWebrtcEchoProbeClass * klass)
{
  ...
  gobject_class->set_property = GST_DEBUG_FUNCPTR (gst_webrtc_echo_probe_set_property);
  gobject_class->get_property = GST_DEBUG_FUNCPTR (gst_webrtc_echo_probe_get_property);
